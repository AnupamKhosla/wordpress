...
function sunset2_sidebar_picture() {
	...
	echo  '<input type="button" class="button button-secondary" value="Upload Profile Picture" id="upload-button" /><input type="hidden" id="profile-picture" name="profile_picture2" value="' . $picture . '" />';
}
...
function sunset2_theme_create_css_page() {
	echo '<h1>Sunset2 Theme css customization</h1>';
}
function sunset2_theme_create_options_page() {
	echo '<h1>Sunset2 Theme Sidebar Options</h1>';
}
